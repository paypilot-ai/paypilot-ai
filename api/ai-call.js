module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const twiml = `<?xml version="1.0" encoding="UTF-8"?><Response><Pause length="1"/><Say voice="Polly.Ruth-Neural">${xmlEsc(greeting)}</Say><Gather input="speech" action="${actionUrl}" method="POST" timeout="5" speechTimeout="0.5" speechModel="phone_call" language="en-US"/><Hangup/></Response>`;
